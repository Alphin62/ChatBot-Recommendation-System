...
def chatbot():
    ...
    st.write("""
         ...
         *** Rule Based Approach : *** A rule-based chatbot is a type of computer program that uses pre-defined rules to determine how to respond to users' inputs based on keywords or phrases, it's a simple chatbot that can handle a limited set of tasks and can't understand more complex or nuanced inputs.
